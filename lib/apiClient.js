...
export const API_BASE_URL =
  process.env.API_BACKEND_URL || "http://localhost:9080";
...
export const whatsappApi = {
  ...
  login: (payload) => apiClient.post("/api/whatsapp/company-auth/login", payload),
  ...
  exchangeEmbeddedSignupCode: (payload) =>
    apiClient.post("/api/whatsapp/company-auth/embedded-signup/exchange", payload),
  completeEmbeddedSignup: (payload) =>
    apiClient.put("/api/whatsapp/company-auth/embedded-signup", payload),
  testOnlineReport: (params) =>
    apiClient.get("/findBySql", { params }),
};
