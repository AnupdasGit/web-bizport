...
export const whatsappApi = {
  ...
  requestPhoneVerificationCode: (payload) =>
    apiClient.post(
      "/api/whatsapp/company-auth/phone-verification/request-code",
      payload,
    ),
  verifyPhoneVerificationCode: (payload) =>
    apiClient.post(
      "/api/whatsapp/company-auth/phone-verification/verify-code",
      payload,
    ),
  ...
  listWhatsAppTemplates: () => apiClient.get("/api/whatsapp/templates"),
  syncMetaWhatsAppTemplates: () =>
    apiClient.post("/api/whatsapp/templates/meta/sync"),
